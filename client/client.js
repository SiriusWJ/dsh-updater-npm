...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zhDict = {
      ...
      updateAvailable: "⚠️ 有新版本：v{from} → v{to}",
      upToDate: "✅ 已是最新（v{v}）",
      updating: "正在通过 npm 更新…",
      updated: "✅ 已更新: v{from} → v{to}",
      stagedReady: "✅ 新版 v{version} 已就绪——点「重启 DSH」生效",
      pendingSwapReady: "✅ 新版 v{version} 已暂存——点「重启 DSH」生效",
      restartHint: "⚠️ 重启 DSH 后生效",
      noUpdate: "已是最新，无需更新",
      updateFail: "更新失败: ",
      hintWrap: "（{hint}）",
      mode: "运行模式",
      ...
      srcBehind: "落后 {n} 个提交",
      srcAhead: "领先 {n} 个提交",
      srcUpdateAvailable: "⚠️ 有新更新：{from} → {to}（落后 {behind} 个提交）",
      srcUpToDate: "✅ 源码树已是最新（{commit}）",
      srcDirty: "⚠️ 工作区有未提交修改",
      srcGitMissing: "⚠️ 未检测到 git",
      srcNotRepo: "⚠️ 当前目录不是 git 仓库",
      srcFetchFailed: "⚠️ git fetch 失败",
      srcUpdateBtn: "源码树更新（git pull）",
      srcUpdating: "正在更新源码树…",
      srcUpdated: "✅ 源码树已更新: {before} → {after}",
      srcNoUpdate: "源码树已是最新",
      srcFail: "源码树更新失败: ",
      pwshMissingHint: "未检测到 PowerShell 7",
    ...
    stagingWasteFound: "⚠️ 遗留暂存目录 {n} 个 / {mb} MB",
    npmResidualFound: "⚠️ npm 安装残留 {n} 个 / {mb} MB",
    rollbackFound: "回滚点 {n} 个 / {mb} MB",
    cleanupBtn: "清理遗留文件",
    cleanupRunning: "正在清理…",
    cleanupDone: "✅ 已清理 {n} 项，释放 {mb} MB",
    cleanupFail: "清理失败: ",
    rollbackBtn: "清理回滚点",
    rollbackRunning: "正在清理回滚点…",
    rollbackDone: "✅ 已清理 {n} 个回滚点，释放 {mb} MB",
    rollbackFail: "清理回滚点失败: ",
    pluginVer: "插件版本",
    pluginOutdatedTitle: "插件需先更新",
    pluginBlocked: "已禁用更新：请先更新插件",
    pluginCheckFail: "插件版本检查失败",
    copyBtn: "复制命令",
    copied: "已复制",
    pluginUpToDate: "插件已是最新",
      repairBtn: "修复部署（重装当前版本）",
      repairRunning: "正在修复部署…",
      repairDone: "✅ 部署已修复——点「重启 DSH」生效",
      repairFail: "部署修复失败: ",
      copiesWarn: "⚠️ 检测到 {n} 个其它 dsh 副本（不会被更新）",
      npmMismatch: "PATH 上的 npm 与当前实例不同源，将用实例自带的 npm",
      localVer: "本地版本",
      remoteVer: "远端版本",
      checkedAt: "最近检查",
      modeSource: "源码树",
      ...
      docsToggleOn: "已开启",
      docsToggleOff: "已关闭",
      docsToggleOnHint: "开启后自动同步并加载文档工具",
      docsToggleOffHint: "不同步、不加载文档工具",
      docsNotEnabled: "文档同步未开启",
      docsReading: "正在读取文档状态…",
      statusFail: "状态读取失败: ",
      docsNotReady: "本地还没有文档，点「同步官方文档」",
      docsReady: "✅ 本地文档已就绪（{n} 篇：EN {en} / 中文 {zh}）",
      docsSyncing: "正在同步官方文档…",
    ...
    var enDict = {
      ...
      updateAvailable: "⚠️ New version: v{from} → v{to}",
      upToDate: "✅ Up to date (v{v})",
      updating: "Updating via npm…",
      updated: "✅ Updated: v{from} → v{to}",
      stagedReady: "✅ v{version} staged — click \"Restart DSH\" to apply",
      pendingSwapReady: "✅ v{version} staged — click \"Restart DSH\" to apply",
      restartHint: "⚠️ Restart DSH to apply",
      ...
      srcUpdateAvailable: "⚠️ Update available: {from} → {to} ({behind} commits behind)",
      srcUpToDate: "✅ Source tree up to date ({commit})",
      srcDirty: "⚠️ Working tree has uncommitted changes",
      srcGitMissing: "⚠️ git not detected",
      srcNotRepo: "⚠️ Not a git repository",
      srcFetchFailed: "⚠️ git fetch failed",
      ...
      pwshMissingHint: "PowerShell 7 not detected",
    ...
    lastRestartFail: "Last restart: swap failed, rolled back",
    ...
    stagingWasteFound: "⚠️ {n} leftover staging dir(s), {mb} MB",
    npmResidualFound: "⚠️ {n} npm leftover(s), {mb} MB",
    rollbackFound: "rollback point(s): {n}, {mb} MB",
    cleanupBtn: "Clean leftovers",
    cleanupRunning: "Cleaning…",
    cleanupDone: "✅ Cleaned {n} item(s), freed {mb} MB",
    cleanupFail: "Cleanup failed: ",
    rollbackBtn: "Remove rollback point",
    rollbackRunning: "Removing…",
    rollbackDone: "✅ Removed {n} rollback point(s), freed {mb} MB",
    rollbackFail: "Rollback cleanup failed: ",
    pluginVer: "Plugin version",
    pluginOutdatedTitle: "Update the plugin first",
    pluginBlocked: "Update disabled: update the plugin first",
    ...
    pluginUpToDate: "Plugin is up to date",
      ...
      repairRunning: "Repairing deployment…",
      repairDone: "✅ Deployment repaired — click \"Restart DSH\" to apply",
      repairFail: "Deployment repair failed: ",
      copiesWarn: "⚠️ {n} other dsh copy(ies) found (not updated)",
      npmMismatch: "PATH npm differs from this instance — using the instance's own npm",
      ...
      waiting: "Downloading / installing…",
      docsTitle: "DSH Docs (official)",
      docsToggleLabel: "Auto-sync official docs",
      docsToggleOn: "On",
      docsToggleOff: "Off",
      docsToggleOnHint: "Syncs automatically and loads the docs tools",
      docsToggleOffHint: "No sync, docs tools not loaded",
      docsNotEnabled: "Docs sync is off",
      docsReading: "Reading docs status…",
      statusFail: "Status read failed: ",
      docsNotReady: "No local docs — click \"Sync official docs\"",
      docsReady: "✅ Local docs ready ({n} files: EN {en} / zh {zh})",
      docsSyncing: "Syncing official docs…",
    ...
    function apply(ctx) {
      ...
      function UpdView() {
        ...
        // 回滚点清理状态
        var rb0 = react.useState(null)
        var rollback = rb0[0]
        var setRollback = rb0[1]
        // 「复制命令」反馈
        ...
        // 删除回滚点（旧版本部署目录）：只在新版已经跑起来后才该点
        var runCleanupRollback = function () {
          setRollback({ phase: "running", result: null })
          fetch("/dsh-updater-npm/cleanup-rollback?uilang=" + uiLang(), { method: "POST", cache: "no-store", signal: AbortSignal.timeout(180000) })
            .then(function (r) { return r.json() })
            .then(function (result) { setRollback({ phase: "done", result: result }); runCheck() })
            .catch(function (error) { setRollback({ phase: "done", result: { ok: false, error: String((error && error.message) || error) } }) })
        }
        ...
        return el("div", { style: cardStyle },
          ...
          data && data.ok && (data.stagingWaste || data.npmResiduals) ? el("div", { style: { display: "flex", gap: 8, marginTop: 6, alignItems: "center", flexWrap: "wrap" } },
            ...
            cleanup !== null && cleanup.phase === "done"
              ...
              : null) : null,
          // 回滚点：只在「新版已经跑起来」之后才有意义（宿主端已保证不列出当前版本）
          data && data.ok && data.rollback && data.rollback.count > 0 ? el("div", { style: { display: "flex", gap: 8, marginTop: 6, alignItems: "center", flexWrap: "wrap" } },
            el("div", { style: { fontSize: 12, opacity: 0.8 } }, t("rollbackFound", { n: data.rollback.count, mb: fmtMb(data.rollback.bytes) })),
            el("button", { style: btnStyle, onClick: runCleanupRollback, disabled: rollback !== null && rollback.phase === "running" },
              rollback !== null && rollback.phase === "running" ? t("rollbackRunning") : t("rollbackBtn")),
            rollback !== null && rollback.phase === "done"
              ? el("div", { style: rollback.result && rollback.result.ok ? okStyle : errStyle },
                  rollback.result && rollback.result.ok
                    ? t("rollbackDone", { n: rollback.result.files, mb: fmtMb(rollback.result.bytes) })
                    : t("rollbackFail") + ((rollback.result && rollback.result.error) || t("unknownError")))
              : null) : null,
